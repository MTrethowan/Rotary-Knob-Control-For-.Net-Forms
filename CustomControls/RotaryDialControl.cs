// ==============================================================================
// RotaryDialControl.cs
// ==============================================================================
// 
// Project:      CustomControls
// Description:  A customizable rotary dial control with 8 tick marks
// 
...
//               160-degree rotation range with 8 customizable tick labels.
// 
// Change Log:
//   v1.0.0 - 2026-06-12 - Initial release
//            - 160-degree rotary dial functionality (280° to 80°)
//            - 8 tick marks with customizable text labels
...
{
    /// <summary>
    /// A rotary dial control with 8 tick marks and customizable labels.
    /// Supports mouse drag, click, and scroll wheel interaction.
    /// </summary>
    /// <remarks>
    /// This control provides a 160-degree dial interface with 8 tick marks positioned
    /// from 280° (bottom-left) to 80° (top-right). The control supports custom images 
    /// and offers multiple interaction methods including mouse wheel support without requiring focus.
    /// </remarks>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RotaryDialControl))]
    [Description("A rotary dial control with 8 tick marks")]
    [DefaultEvent("ValueChanged")]
    [DefaultProperty("Value")]
    public class RotaryDialControl : Control
    {
        private float _value = 0f;
        private float _minimum = 0f;
        private float _maximum = 7f;
        private float _startAngle = 280f; // Starting position (labeled as 0) - lower left
        private float _endAngle = 80f;    // Ending position (labeled as 7) - upper right
        ...
        private string[] _tickLabels = new string[] { "0", "1", "2", "3", "4", "5", "6", "7" };
        ...
        /// </remarks>
        [Category("Behavior")]
        [Description("Gets or sets the current value of the dial (0-7).")]
        public float Value
        {
            get { return _value; }
            set
        ...
        /// <summary>
        /// Gets or sets the minimum value allowed for the dial.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the maximum value allowed for the dial.
        /// </summary>
        /// <value>The maximum value. Default is 7.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets the custom labels for the 8 tick marks.
        /// </summary>
        /// <value>An array of 8 strings for the tick labels. Default is { "0", "1", "2", "3", "4", "5", "6", "7" }.</value>
        /// <remarks>
        /// This array must contain exactly 8 elements corresponding to the 8 tick marks.
        ...
        /// <summary>
        /// Gets or sets the label text for the first tick mark (280 degrees).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 1 (280°)")]
        [DefaultValue("0")]
        ...
        /// <summary>
        /// Gets or sets the label text for the seventh tick mark.
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 7")]
        [DefaultValue("6")]
        ...
        /// <summary>
        /// Gets or sets the label text for the eighth tick mark (80 degrees).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 8 (80°)")]
        [DefaultValue("7")]
        public string TickLabel8
        {
            get { return _tickLabels[7]; }
            set { _tickLabels[7] = value ?? "7"; Invalidate(); }
        }
        ...
        /// </summary>
        /// <remarks>
        /// This event is raised whenever the dial value changes through user interaction 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RotaryDialControl"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// Default size is 150x150 pixels with a value range of 0-7 and 160-degree rotation (280° to 80°).
        /// </remarks>
        public RotaryDialControl()
        {
            ...
            this.MouseWheel += RotaryDialControl_MouseWheel;
        }

        /// <summary>
        /// Handles mouse wheel input when the cursor is over the control.
        /// </summary>
        private void RotaryDialControl_MouseWheel(object sender, MouseEventArgs e)
        {
        ...
        /// <summary>
        /// Raises the <see cref="Control.OnPaint"/> event and renders the dial control.
        /// </summary>
