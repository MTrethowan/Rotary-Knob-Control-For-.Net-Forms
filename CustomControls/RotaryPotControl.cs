...
// Description:  A 180-degree rotary potentiometer control with 7 tick marks
// 
...
//               180-degree rotation range with 7 customizable tick labels.
// 
// Change Log:
//   v1.0.0 - 2026-06-12 - Initial release
//            - 180-degree rotary potentiometer functionality
//            - 7 tick marks with customizable text labels
...
{
    /// <summary>
    /// A 180-degree rotary potentiometer control with 7 tick marks and customizable labels.
    /// Supports mouse drag, click, and scroll wheel interaction.
    /// </summary>
    /// <remarks>
    /// This control provides a semi-circular dial interface perfect for potentiometer controls.
    /// It features 7 tick marks with customizable text labels (default 0-6).
    /// The control supports custom images and offers multiple interaction methods including 
    /// mouse wheel support without requiring focus.
    /// </remarks>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RotaryPotControl))]
    [Description("A 180-degree rotary potentiometer control with 7 tick marks")]
    [DefaultEvent("ValueChanged")]
    [DefaultProperty("Value")]
    public class RotaryPotControl : Control
    {
        private float _value = 0f;
        private float _minimum = 0f;
        private float _maximum = 6f;
        private float _startAngle = 270f; // Starting position (labeled as 0) - bottom
        private float _endAngle = 90f;    // Ending position (labeled as 6) - top
        ...
        private string[] _tickLabels = new string[] { "0", "1", "2", "3", "4", "5", "6" };
        ...
        /// </remarks>
        [Category("Behavior")]
        [Description("Gets or sets the current value of the potentiometer (0-6).")]
        public float Value
        {
            get { return _value; }
            set
        ...
        /// <summary>
        /// Gets or sets the minimum value allowed for the potentiometer.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the maximum value allowed for the potentiometer.
        /// </summary>
        /// <value>The maximum value. Default is 6.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets the custom labels for the 7 tick marks.
        /// </summary>
        /// <value>An array of 7 strings for the tick labels. Default is { "0", "1", "2", "3", "4", "5", "6" }.</value>
        /// <remarks>
        /// This array must contain exactly 7 elements corresponding to the 7 tick marks.
        ...
        /// <summary>
        /// Gets or sets the label text for the first tick mark (bottom position).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 1 (bottom position)")]
        [DefaultValue("0")]
        ...
        /// <summary>
        /// Gets or sets the label text for the fourth tick mark (middle position).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 4 (middle position)")]
        [DefaultValue("3")]
        ...
        /// <summary>
        /// Gets or sets the label text for the sixth tick mark.
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 6")]
        [DefaultValue("5")]
        ...
        /// <summary>
        /// Gets or sets the label text for the seventh tick mark (top position).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 7 (top position)")]
        [DefaultValue("6")]
        public string TickLabel7
        {
        ...
        /// </summary>
        /// <remarks>
        /// This event is raised whenever the potentiometer value changes through user interaction 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RotaryPotControl"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// Default size is 150x100 pixels with a value range of 0-6 and 180-degree rotation.
        /// </remarks>
        public RotaryPotControl()
        {
            ...
            this.MouseWheel += RotaryPotControl_MouseWheel;
        }

        /// <summary>
        /// Handles mouse wheel input when the cursor is over the control.
        /// </summary>
        private void RotaryPotControl_MouseWheel(object sender, MouseEventArgs e)
        {
        ...
        /// <summary>
        /// Raises the <see cref="Control.OnPaint"/> event and renders the potentiometer control.
        /// </summary>
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            int centerX = Width / 2;      // Horizontally centered
            int centerY = Height / 2;     // Vertically centered
        ...
        {
            int centerX = Width / 2;
            int centerY = Height / 2;    // Same as in OnPaint (vertically centered)
