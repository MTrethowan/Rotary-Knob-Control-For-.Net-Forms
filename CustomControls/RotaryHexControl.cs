...
// Description:  A customizable rotary hex control with 6 tick marks
// 
...
//               200-degree rotation range with 6 customizable tick labels.
// 
// Change Log:
//   v1.0.0 - 2026-06-12 - Initial release
//            - 200-degree rotary hex control (280° to 80°)
...
{
    /// <summary>
    /// A rotary hex control with 6 tick marks and customizable labels.
    /// Supports mouse drag, click, and scroll wheel interaction.
    /// </summary>
    /// <remarks>
    /// This control provides a 200-degree dial interface with 6 tick marks positioned
    ...
    /// </remarks>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(RotaryHexControl))]
    [Description("A rotary hex control with 6 tick marks")]
    [DefaultEvent("ValueChanged")]
    [DefaultProperty("Value")]
    public class RotaryHexControl : Control
    {
        private float _value = 0f;
        private float _minimum = 0f;
        private float _maximum = 5f;
        private float _startAngle = 280f; // Starting position (labeled as 0) - bottom-left
        private float _endAngle = 80f;    // Ending position (labeled as 5) - top-right
        ...
        /// </remarks>
        [Category("Behavior")]
        [Description("Gets or sets the current value of the dial (0-5).")]
        public float Value
        {
            get { return _value; }
            set
        ...
        /// <summary>
        /// Gets or sets the label text for the sixth tick mark (80 degrees).
        /// </summary>
        [Category("Appearance")]
        [Description("Label text for tick mark 6 (80°)")]
        [DefaultValue("5")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RotaryHexControl"/> class.
        /// </summary>
        /// <remarks>
        ...
        /// Default size is 150x150 pixels with a value range of 0-5 and 200-degree rotation (280° to 80°).
        /// </remarks>
        public RotaryHexControl()
        {
            ...
            this.MouseWheel += RotaryHexControl_MouseWheel;
        }

        /// <summary>
        /// Handles mouse wheel input when the cursor is over the control.
        /// </summary>
        private void RotaryHexControl_MouseWheel(object sender, MouseEventArgs e)
        {
